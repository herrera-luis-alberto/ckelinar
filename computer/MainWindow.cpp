...
MainWindow::MainWindow(TrajectoryForecasterInterface *forecaster)
...
void MainWindow::reloadMap()
{
    ...
    EarthTrajectory staticPredictedUp = forecaster_->getTrayectory( init, upSpeed->value(), 100); //deltaT = 100
  ...
  EarthTrajectory staticPredictedDown = forecaster_->getTrayectory( releasePoint[0], downSpeed->value(), 100);
